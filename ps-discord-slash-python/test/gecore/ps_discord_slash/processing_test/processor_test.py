...
class CommandProcessorTest(unittest.TestCase):
    def test_find_command_from_list(self):
        ...
        result = loaded_commands.available_commands.retrieve_command(search_base_id)
        self.assertEqual(OvOSlashCommand.SEARCH_BASE_ID, result.identify())
    ...
    def test_process_command(self):
        ...
        result = process_command_request(loaded_json)
